package com.youshangdache.payment.service.impl;
...
import com.youshangdache.common.util.RequestUtils;
import com.youshangdache.driver.DriverAccountFeignClient;
import com.youshangdache.model.entity.payment.PaymentInfo;
...
import com.youshangdache.model.vo.order.OrderProfitsharingVo;
import com.youshangdache.model.vo.order.OrderRewardVo;
import com.youshangdache.model.vo.payment.WxPrepayVo;
import com.youshangdache.order.OrderInfoFeignClient;
import com.youshangdache.payment.config.WxPayV3Properties;
import com.youshangdache.payment.mapper.PaymentInfoMapper;
...
public class WxPayServiceImpl implements WxPayService {
    ...
    public void handlerOrder(String orderNo) {
        ...
        //分账处理
        OrderProfitsharingVo orderProfitsharingVo = orderInfoFeignClient.getOrderProfitsharing(orderRewardVo.getOrderId());
        //封装分账参数对象
