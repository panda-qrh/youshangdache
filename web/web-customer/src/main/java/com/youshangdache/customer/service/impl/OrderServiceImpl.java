...
public class OrderServiceImpl implements OrderService {
    ...
    public Boolean queryPayStatus(String orderNo) {
        return wxPayFeignClient.queryPayStatus(orderNo);
    }
    ...
    public WxPrepayVo createWxPayment(CreateWxPaymentForm createWxPaymentForm) {
        ...
        //2.获取乘客微信openId
        String customerOpenId = customerInfoFeignClient.getCustomerOpenId(orderPayVo.getCustomerId());

        //3.获取司机微信openId
        String driverOpenId = driverInfoFeignClient.getDriverOpenId(orderPayVo.getDriverId());
        ...
        if (null == orderPayVo.getCouponAmount() &&
            ...
            couponAmount = couponFeignClient.useCoupon(useCouponForm);
        }
        //更新订单支付金额
        ...
        return wxPayFeignClient.createWxPayment(paymentInfoForm);
    }
    ...
    public OrderLocationVo getCacheOrderLocation(Long orderId) {
        return locationFeignClient.getCacheOrderLocation(orderId);
    }
    ...
    public DriverInfoVo getDriverInfo(Long orderId, Long customerId) {
        ...
        return driverInfoFeignClient.getDriverInfo(orderInfo.getDriverId());
    }
    ...
    public OrderInfoVo getOrderInfoByOrderId(Long orderId, Long customerId) {
        ...
        if (driverId != null) {
            driverInfoVo = driverInfoFeignClient.getDriverInfo(driverId);
        }
    ...
    public ExpectOrderVo expectOrder(ExpectOrderForm expectOrderForm) {
        ...
        DrivingLineVo drivingLineVo = mapFeignClient.calculateDrivingLine(calculateDrivingLineForm);
        ...
        FeeRuleResponseVo feeRuleResponseVo = feeRuleFeignClient.calculateOrderFee(calculateOrderFeeForm);
    ...
    public Long submitOrder(SubmitOrderForm submitOrderForm) {
        ...
        //4.保存订单信息
        Long orderId = orderInfoFeignClient.saveOrderInfo(orderInfoForm);
