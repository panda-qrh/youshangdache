...
import com.youshangdache.driver.CiFeignClient;
...
import com.youshangdache.order.OrderMonitorFeignClient;
...
public class MonitorServiceImpl implements MonitorService {
    ...
    public Boolean upload(MultipartFile file, OrderMonitorForm orderMonitorForm) {
        ...
        //记录审核结果
        TextAuditingVo textAuditingVo = ciFeignClient.textAuditing(orderMonitorForm.getContent());
