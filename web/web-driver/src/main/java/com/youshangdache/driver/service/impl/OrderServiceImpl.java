...
import com.youshangdache.driver.service.OrderService;
import com.youshangdache.map.LocationFeignClient;
import com.youshangdache.map.MapFeignClient;
...
import com.youshangdache.model.form.order.OrderFeeForm;
...
import com.youshangdache.rules.FeeRuleFeignClient;
import com.youshangdache.rules.ProfitsharingRuleFeignClient;
import com.youshangdache.rules.RewardRuleFeignClient;
...
public class OrderServiceImpl implements OrderService {
    ...
    public Boolean sendOrderBillInfo(Long orderId, Long driverId) {
        return orderInfoFeignClient.sendOrderBillInfo(orderId, driverId);
    }
    ...
    public Boolean endDrive(OrderFeeForm orderFeeForm) {
        ...
        CompletableFuture<OrderInfo> orderInfoCF = CompletableFuture.supplyAsync(
                () -> orderInfoFeignClient.getOrderInfoByOrderId(orderFeeForm.getOrderId()),
                threadPoolExecutor);
        ...
        CompletableFuture<OrderServiceLastLocationVo> orderServiceLastLocationVoCF = CompletableFuture.supplyAsync(
                () -> locationFeignClient.getOrderServiceLastLocation(orderFeeForm.getOrderId()),
                threadPoolExecutor);
        ...
        CompletableFuture<BigDecimal> realDistanceCF = CompletableFuture.supplyAsync(
                () -> locationFeignClient.calculateOrderRealDistance(orderFeeForm.getOrderId()),
                threadPoolExecutor);
        ...
        CompletableFuture<FeeRuleResponseVo> feeRuleResponseVoCF = realDistanceCF.thenApplyAsync((realDistance) -> {
            ...
            FeeRuleRequestForm feeRuleRequestForm=FeeRuleRequestForm.builder()
                    ...
                    .build();
            FeeRuleResponseVo feeRuleResponseVo = feeRuleFeignClient.calculateOrderFee(feeRuleRequestForm);
        ...
        CompletableFuture<RewardRuleResponseVo> rewardRuleResponseVoCF = orderNumCF.thenApplyAsync((orderNum) -> {
            ...
            //5.3.执行
            return rewardRuleFeignClient.calculateOrderRewardFee(rewardRuleRequestForm);
        }, threadPoolExecutor);
        ...
        CompletableFuture<ProfitsharingRuleResponseVo> profitsharingRuleResponseVoCF = feeRuleResponseVoCF.thenCombineAsync(
                ...
                (feeRuleResponseVo, orderNum) -> {
                    ...
                    return profitsharingRuleFeignClient.calculateProfitSharingFee(profitsharingRuleRequestForm);
                },
                threadPoolExecutor);
    ...
    public Boolean startDrive(StartDriveForm startDriveForm) {
        return orderInfoFeignClient.startDrive(startDriveForm);
    }
    ...
    public Boolean updateOrderCart(UpdateOrderCartForm updateOrderCartForm) {
        return orderInfoFeignClient.updateOrderCart(updateOrderCartForm);
    }
    ...
    public Boolean driverArriveStartLocation(Long orderId, Long driverId) {
        ...
        OrderLocationVo orderLocationVo = locationFeignClient.getCacheOrderLocation(orderId);
        ...
        return orderInfoFeignClient.driverArriveStartLocation(orderId, driverId);
    }
    ...
    public Boolean robNewOrder(Long driverId, Long orderId) {
        return orderInfoFeignClient.robNewOrder(driverId, orderId);
    }
    ...
    public CurrentOrderInfoVo searchDriverCurrentOrder(Long driverId) {
        return orderInfoFeignClient.searchDriverCurrentOrder(driverId);
    }
    ...
    public OrderStatusEnum getOrderStatus(Long orderId) {
        return orderInfoFeignClient.getOrderStatus(orderId);
    }
